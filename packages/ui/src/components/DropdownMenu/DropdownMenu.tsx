...
function DropdownMenuSubTrigger({ className, inset, children, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & { inset?: boolean; ref?: Ref<HTMLDivElement> }) {
  return (
...
function DropdownMenuSubContent({ className, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubContent> & { ref?: Ref<HTMLDivElement> }) {
  return (
...
function DropdownMenuContent({ className, sideOffset = 4, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Content> & { ref?: Ref<HTMLDivElement> }) {
  return (
...
function DropdownMenuItem({ className, inset, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & { inset?: boolean; ref?: Ref<HTMLDivElement> }) {
  return <DropdownMenuPrimitive.Item ref={ref} className={cn("relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", inset && "pl-8", className)} {...props} />;
}

function DropdownMenuCheckboxItem({ className, children, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.CheckboxItem> & { ref?: Ref<HTMLDivElement> }) {
  return (
    <DropdownMenuPrimitive.CheckboxItem ref={ref} className={cn("relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)} {...props}>
...
function DropdownMenuRadioItem({ className, children, ref, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.RadioItem> & { ref?: Ref<HTMLDivElement> }) {
  return (
