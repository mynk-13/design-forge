...
<StorybookPreview src="https://designforge-storybook.vercel.app/iframe.html?id=data-display-datatable--default&viewMode=story" />

[Open DataTable in Storybook →](https://designforge-storybook.vercel.app/?path=/story/data-display-datatable--default)
