...
Open the URL shown in your terminal after `npm run dev` starts — typically `http://localhost:3000`, but Next.js will pick an available port if 3000 is in use. You should see a card with a button.
