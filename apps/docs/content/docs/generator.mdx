...
<div className="not-prose mt-8 mb-4">
  <a href="/generator" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 bg-violet-600 hover:bg-violet-700 text-white h-10 px-8 gap-2">
    Launch AI Generator
  </a>
</div>
